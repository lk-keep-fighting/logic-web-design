import FnContext from '../runner/functions/context';
/**
 ...
 * @returns
 */
export function getByJsTplString(script: string, ctx: FnContext): any {
 ...
 * @returns
 */
export async function runJsExpress(jsScript: string, ctx: FnContext) {
