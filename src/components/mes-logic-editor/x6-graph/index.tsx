...
import { GraphToLogic, GraphToProcessLogic } from '@/components/step-flow-core/lasl/parser/logic-parser';
import './index.css';
...
export default class X6Graph extends React.Component<EditorProps, StateType> {
  ...
  convertGraphToDsl = (graphJson: any) => {
    const _flow = GraphToProcessLogic(this.props.config?.id, graphJson.cells);
