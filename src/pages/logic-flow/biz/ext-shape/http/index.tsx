    ...
    return (
        <Popover content={memo ? <Input.TextArea style={{ width: 300, height: 200 }} readOnly value={memo} ></Input.TextArea> : ''} trigger="click" mouseLeaveDelay={0}>
            <div
                ...
                style={{
                    width: '100%', height: '100%', border: '1px solid rgb(20, 145, 235)', borderRadius: '5px', position: 'relative',
                    overflow: 'hidden',
                    backgroundColor: 'white'
                }}
            >
                <img src={`/logic/icons/${type}.svg`} style={{ width: 20, height: 20, position: 'absolute', top: 0, left: 5, margin: 0 }} />
